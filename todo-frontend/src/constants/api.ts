export const API_PATHS = {
  ...
  FREETIME_TODO: "/api/freetime-todo",
  REVIEWS: "/api/reviews",
  ...
  HABITS_TODAY: (date?: string) =>
    date ? `/api/habits/today?date=${encodeURIComponent(date)}` : "/api/habits/today",
  HABITS: "/api/habits",
  HABIT_BY_ID: (id: string) => `/api/habits/${id}`,
  HABIT_TOGGLE: (id: string) => `/api/habits/${id}/toggle`,
  HABIT_SKIP: (id: string) => `/api/habits/${id}/skip`,
